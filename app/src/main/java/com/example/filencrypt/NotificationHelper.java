...
public class NotificationHelper {
    ...
    public NotificationHelper(Context context) {
        ...
        this.builder = new NotificationCompat.Builder(context, "filencrypt_progress");

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel("filencrypt_progress", "Progress updates", NotificationManager.IMPORTANCE_DEFAULT);
